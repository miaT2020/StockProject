...
import stocks.domainbean.StockBean;
...
public class StockController {
	...
	public List<StockBean> getTickers(){
		...
		for (StockObject ticker : tickers) {
			StockBean stockBean = new StockBean();
			  ...
			  stockBean.setDescription(ticker.getDescription());
			  stockBean.setDisplayText(ticker.getTicker() + " (" + ticker.getCompanyName() + ")");
