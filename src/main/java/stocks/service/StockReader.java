...
public class StockReader{
	...
	public static  ArrayList<StockObject> fetchAvailableStockSymbols() throws Exception {
		String country = "United State";
		String stockURL = "https://api.twelvedata.com/stocks?country=" + country  + "&apikey=" + Main.API_KEY;
